...
# Deploy oppen-webchat static app to S3
...
# Icons and images: 1 day cache
echo "  Uploading icons/images..."
aws s3 sync "$ARTIFACT_PATH" "s3://$S3_BUCKET" \
    --region "$AWS_REGION" \
